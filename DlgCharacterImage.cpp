...
void CDlgCharacterImage::UpdateCharacterImageData(int& iNumImage)
{
	...
	if ( bTraining != FALSE )
	{
		...
		if ( iNumImage >= (int)::GetPreferences().m_nItemsTrainingImages) iNumImage = ::GetPreferences().m_nItemsTrainingImages - 1;
	...
	else
	{
		...
		if ( iNumImage < 0 ) iNumImage = 0;
		if ( iNumImage >= (int)::GetPreferences().m_nItemsTestingImages ) iNumImage = ::GetPreferences().m_nItemsTestingImages - 1;
